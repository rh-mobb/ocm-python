...
class InlineResponse20030(object):
    ...
    @property
    def page(self):
        """Gets the page of this InlineResponse20030.  # noqa: E501

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :return: The page of this InlineResponse20030.  # noqa: E501
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        """Sets the page of this InlineResponse20030.

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :param page: The page of this InlineResponse20030.  # noqa: E501
        :type: int
        """
