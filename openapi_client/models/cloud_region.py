...
class CloudRegion(object):
    ...
    def __init__(self, kind=None, id=None, href=None, ccs_only=None, cloud_provider=None, display_name=None, enabled=None, name=None, supports_hypershift=None, supports_multi_az=None, local_vars_configuration=None):  # noqa: E501
    ...
    def enabled(self):
        ...
        Whether the region is enabled for deploying an OSD cluster.  # noqa: E501
