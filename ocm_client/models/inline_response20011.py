...
class InlineResponse20011(object):
    ...
    @property
    def size(self):
        """Gets the size of this InlineResponse20011.  # noqa: E501

        Maximum number of items that will be contained in the returned page.  # noqa: E501

        :return: The size of this InlineResponse20011.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this InlineResponse20011.

        Maximum number of items that will be contained in the returned page.  # noqa: E501

        :param size: The size of this InlineResponse20011.  # noqa: E501
        :type: int
        """
