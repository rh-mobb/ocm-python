...
class InlineResponse20025(object):
    ...
    @property
    def page(self):
        """Gets the page of this InlineResponse20025.  # noqa: E501

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :return: The page of this InlineResponse20025.  # noqa: E501
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        """Sets the page of this InlineResponse20025.

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :param page: The page of this InlineResponse20025.  # noqa: E501
        :type: int
        """
    ...
    @property
    def size(self):
        """Gets the size of this InlineResponse20025.  # noqa: E501

        Number of items contained in the returned page.  # noqa: E501

        :return: The size of this InlineResponse20025.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this InlineResponse20025.

        Number of items contained in the returned page.  # noqa: E501

        :param size: The size of this InlineResponse20025.  # noqa: E501
        :type: int
        """
