...
class InlineResponse20051(object):
    ...
    @property
    def page(self):
        """Gets the page of this InlineResponse20051.  # noqa: E501

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :return: The page of this InlineResponse20051.  # noqa: E501
        :rtype: int
        """
        return self._page
    ...
    @page.setter
    def page(self, page):
        """Sets the page of this InlineResponse20051.

        Index of the requested page, where one corresponds to the first page.  # noqa: E501

        :param page: The page of this InlineResponse20051.  # noqa: E501
        :type: int
        """
    ...
    @property
    def size(self):
        """Gets the size of this InlineResponse20051.  # noqa: E501

        Maximum number of items that will be contained in the returned page.  Default value is `100`.  # noqa: E501

        :return: The size of this InlineResponse20051.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this InlineResponse20051.

        Maximum number of items that will be contained in the returned page.  Default value is `100`.  # noqa: E501

        :param size: The size of this InlineResponse20051.  # noqa: E501
        :type: int
        """
    ...
    def total(self, total):
        """Sets the total of this InlineResponse20051.

        Total number of items of the collection that match the search criteria, regardless of the size of the page.  # noqa: E501

        :param total: The total of this InlineResponse20051.  # noqa: E501
        :type: int
        """
