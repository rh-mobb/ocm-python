...
[**api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete**](DefaultApi.md#api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete) | **DELETE** /api/clusters_mgmt/v1/cloud_providers/{cloud_provider_id}/regions/{region_id} | 
...
[**api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_get**](DefaultApi.md#api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_get) | **GET** /api/clusters_mgmt/v1/clusters/{cluster_id}/delete_protection | 
...
[**api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_post**](DefaultApi.md#api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_post) | **POST** /api/clusters_mgmt/v1/clusters/{cluster_id}/node_pools/{node_pool_id}/upgrade_policies | 
...
[**api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_get**](DefaultApi.md#api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_get) | **GET** /api/clusters_mgmt/v1/clusters/{cluster_id}/tuning_configs/{tuning_config_id} | 
...
# **api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_post**
> CloudRegion api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_post(cloud_provider_id, cloud_region=cloud_region)
...
cloud_region = openapi_client.CloudRegion() # CloudRegion |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **cloud_provider_id** | **str**|  | 
 **cloud_region** | [**CloudRegion**](CloudRegion.md)|  | [optional] 
...
# **api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete**
> api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete(cloud_provider_id, region_id)
...
region_id = 'region_id_example' # str | 
    ...
    try:
        api_instance.api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete(cloud_provider_id, region_id)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_delete: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_patch**
> CloudRegion api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_patch(cloud_provider_id, region_id, cloud_region=cloud_region)
...
cloud_region = openapi_client.CloudRegion() # CloudRegion |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_cloud_providers_cloud_provider_id_regions_region_id_patch: %s\n" % e)
```
...
> InlineResponse200 api_clusters_mgmt_v1_clusters_cluster_id_addon_inquiries_get(cluster_id, order=order, page=page, search=search, size=size)
...
> AddonUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_addon_upgrade_policies_addon_upgrade_policy_id_patch(cluster_id, addon_upgrade_policy_id, addon_upgrade_policy=addon_upgrade_policy)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_addon_upgrade_policies_addon_upgrade_policy_id_state_patch**
> AddonUpgradePolicyState api_clusters_mgmt_v1_clusters_cluster_id_addon_upgrade_policies_addon_upgrade_policy_id_state_patch(cluster_id, addon_upgrade_policy_id, addon_upgrade_policy_state=addon_upgrade_policy_state)
...
> AddonUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_addon_upgrade_policies_post(cluster_id, addon_upgrade_policy=addon_upgrade_policy)
...
> AddOnInstallation api_clusters_mgmt_v1_clusters_cluster_id_addons_addoninstallation_id_patch(cluster_id, addoninstallation_id, add_on_installation=add_on_installation)
...
> AddOnInstallation api_clusters_mgmt_v1_clusters_cluster_id_addons_post(cluster_id, add_on_installation=add_on_installation)
...
> AWSInfrastructureAccessRoleGrant api_clusters_mgmt_v1_clusters_cluster_id_aws_infrastructure_access_role_grants_post(cluster_id, aws_infrastructure_access_role_grant=aws_infrastructure_access_role_grant)
...
> PrivateLinkPrincipal api_clusters_mgmt_v1_clusters_cluster_id_aws_private_link_configuration_principals_post(cluster_id, private_link_principal=private_link_principal)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_control_plane_upgrade_policies_control_plane_upgrade_policy_id_patch**
> ControlPlaneUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_control_plane_upgrade_policies_control_plane_upgrade_policy_id_patch(cluster_id, control_plane_upgrade_policy_id, control_plane_upgrade_policy=control_plane_upgrade_policy)
...
> ControlPlaneUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_control_plane_upgrade_policies_post(cluster_id, control_plane_upgrade_policy=control_plane_upgrade_policy)
...
> DeleteProtection api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_get(cluster_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_get(cluster_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_get: %s\n" % e)
```
...
[**DeleteProtection**](DeleteProtection.md)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_patch**
> DeleteProtection api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_patch(cluster_id, delete_protection=delete_protection)
...
delete_protection = openapi_client.DeleteProtection() # DeleteProtection |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_delete_protection_patch: %s\n" % e)
```
...
> Label api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_labels_label_id_patch(cluster_id, label_id, label=label)
...
> Label api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_labels_post(cluster_id, label=label)
...
> Manifest api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_manifests_manifest_id_patch(cluster_id, manifest_id, manifest=manifest)
...
> Manifest api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_manifests_post(cluster_id, manifest=manifest)
...
> Syncset api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_syncsets_post(cluster_id, syncset=syncset)
...
> Syncset api_clusters_mgmt_v1_clusters_cluster_id_external_configuration_syncsets_syncset_id_patch(cluster_id, syncset_id, syncset=syncset)
...
> VersionGateAgreement api_clusters_mgmt_v1_clusters_cluster_id_gate_agreements_post(cluster_id, version_gate_agreement=version_gate_agreement)
...
> User api_clusters_mgmt_v1_clusters_cluster_id_groups_group_id_users_post(cluster_id, group_id, user=user)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_identity_provider_id_htpasswd_users_htpasswd_user_id_patch**
> HTPasswdUser api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_identity_provider_id_htpasswd_users_htpasswd_user_id_patch(cluster_id, identity_provider_id, htpasswd_user_id, ht_passwd_user=ht_passwd_user)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_identity_provider_id_htpasswd_users_post**
> HTPasswdUser api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_identity_provider_id_htpasswd_users_post(cluster_id, identity_provider_id, ht_passwd_user=ht_passwd_user)
...
> IdentityProvider api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_identity_provider_id_patch(cluster_id, identity_provider_id, identity_provider=identity_provider)
...
> IdentityProvider api_clusters_mgmt_v1_clusters_cluster_id_identity_providers_post(cluster_id, identity_provider=identity_provider)
...
size = 56 # int | Number of items contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_get(cluster_id, page=page, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_get: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_inflight_check_id_get**
> InflightCheck api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_inflight_check_id_get(cluster_id, inflight_check_id)
...
inflight_check_id = 'inflight_check_id_example' # str | 
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_inflight_check_id_get(cluster_id, inflight_check_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_inflight_checks_inflight_check_id_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **cluster_id** | **str**|  | 
 **inflight_check_id** | **str**|  | 

### Return type

[**InflightCheck**](InflightCheck.md)
...
> Ingress api_clusters_mgmt_v1_clusters_cluster_id_ingresses_ingress_id_patch(cluster_id, ingress_id, ingress=ingress)
...
> list[Ingress] api_clusters_mgmt_v1_clusters_cluster_id_ingresses_patch(cluster_id, ingress=ingress)
...
------------- | ------------- | ------------- | -------------
 **cluster_id** | **str**|  | 
 **ingress** | [**list[Ingress]**](Ingress.md)|  | [optional] 
...
> Ingress api_clusters_mgmt_v1_clusters_cluster_id_ingresses_post(cluster_id, ingress=ingress)
...
> LimitedSupportReason api_clusters_mgmt_v1_clusters_cluster_id_limited_support_reasons_post(cluster_id, limited_support_reason=limited_support_reason)
...
> Log api_clusters_mgmt_v1_clusters_cluster_id_logs_install_get(cluster_id, offset=offset, tail=tail)
...
> Log api_clusters_mgmt_v1_clusters_cluster_id_logs_uninstall_get(cluster_id, offset=offset, tail=tail)
...
> MachinePool api_clusters_mgmt_v1_clusters_cluster_id_machine_pools_machine_pool_id_patch(cluster_id, machine_pool_id, machine_pool=machine_pool)
...
> MachinePool api_clusters_mgmt_v1_clusters_cluster_id_machine_pools_post(cluster_id, machine_pool=machine_pool)
...
> NodePool api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_patch(cluster_id, node_pool_id, node_pool=node_pool)
...
size = 56 # int | Number of items contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_get(cluster_id, node_pool_id, page=page, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_get: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_delete**
> api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_delete(cluster_id, node_pool_id, node_pool_upgrade_policy_id)
...
node_pool_upgrade_policy_id = 'node_pool_upgrade_policy_id_example' # str | 
    ...
    try:
        api_instance.api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_delete(cluster_id, node_pool_id, node_pool_upgrade_policy_id)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_delete: %s\n" % e)
```
 ...
 **cluster_id** | **str**|  | 
 **node_pool_id** | **str**|  | 
 **node_pool_upgrade_policy_id** | **str**|  | 
...
# **api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_get**
> NodePoolUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_get(cluster_id, node_pool_id, node_pool_upgrade_policy_id)
...
node_pool_upgrade_policy_id = 'node_pool_upgrade_policy_id_example' # str | 
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_get(cluster_id, node_pool_id, node_pool_upgrade_policy_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_get: %s\n" % e)
```
...
[**NodePoolUpgradePolicy**](NodePoolUpgradePolicy.md)
...
# **api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_patch**
> NodePoolUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_patch(cluster_id, node_pool_id, node_pool_upgrade_policy_id, node_pool_upgrade_policy=node_pool_upgrade_policy)
...
node_pool_upgrade_policy = openapi_client.NodePoolUpgradePolicy() # NodePoolUpgradePolicy |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_node_pool_upgrade_policy_id_patch: %s\n" % e)
```
 ...
 **node_pool_id** | **str**|  | 
 **node_pool_upgrade_policy_id** | **str**|  | 
 **node_pool_upgrade_policy** | [**NodePoolUpgradePolicy**](NodePoolUpgradePolicy.md)|  | [optional] 
...
> NodePoolUpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_post(cluster_id, node_pool_id, node_pool_upgrade_policy=node_pool_upgrade_policy)
...
node_pool_upgrade_policy = openapi_client.NodePoolUpgradePolicy() # NodePoolUpgradePolicy |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_node_pools_node_pool_id_upgrade_policies_post: %s\n" % e)
```
...
> NodePool api_clusters_mgmt_v1_clusters_cluster_id_node_pools_post(cluster_id, node_pool=node_pool)
...
> Cluster api_clusters_mgmt_v1_clusters_cluster_id_patch(cluster_id, cluster=cluster)
...
> ProvisionShard api_clusters_mgmt_v1_clusters_cluster_id_provision_shard_patch(cluster_id, provision_shard=provision_shard)
...
> OperatorIAMRole api_clusters_mgmt_v1_clusters_cluster_id_sts_operator_roles_post(cluster_id, operator_iam_role=operator_iam_role)
...
size = 56 # int | Number of items contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_get(cluster_id, page=page, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_get: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_post**
> TuningConfig api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_post(cluster_id, tuning_config=tuning_config)
...
tuning_config = openapi_client.TuningConfig() # TuningConfig |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_post: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **cluster_id** | **str**|  | 
 **tuning_config** | [**TuningConfig**](TuningConfig.md)|  | [optional] 

### Return type

[**TuningConfig**](TuningConfig.md)
...
> api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_delete(cluster_id, tuning_config_id)
...
tuning_config_id = 'tuning_config_id_example' # str | 
    ...
    try:
        api_instance.api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_delete(cluster_id, tuning_config_id)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_delete: %s\n" % e)
```
...
> TuningConfig api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_get(cluster_id, tuning_config_id)
...
tuning_config_id = 'tuning_config_id_example' # str | 
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_get(cluster_id, tuning_config_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_get: %s\n" % e)
```
...
> TuningConfig api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_patch(cluster_id, tuning_config_id, tuning_config=tuning_config)
...
tuning_config = openapi_client.TuningConfig() # TuningConfig |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_clusters_cluster_id_tuning_configs_tuning_config_id_patch: %s\n" % e)
```
...
> UpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_upgrade_policies_post(cluster_id, upgrade_policy=upgrade_policy)
...
> UpgradePolicy api_clusters_mgmt_v1_clusters_cluster_id_upgrade_policies_upgrade_policy_id_patch(cluster_id, upgrade_policy_id, upgrade_policy=upgrade_policy)
...
> UpgradePolicyState api_clusters_mgmt_v1_clusters_cluster_id_upgrade_policies_upgrade_policy_id_state_patch(cluster_id, upgrade_policy_id, upgrade_policy_state=upgrade_policy_state)
...
> Cluster api_clusters_mgmt_v1_clusters_post(cluster=cluster)
...
> api_clusters_mgmt_v1_dns_domains_dns_domain_id_delete(dns_domain_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.api_clusters_mgmt_v1_dns_domains_dns_domain_id_delete(dns_domain_id)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_dns_domains_dns_domain_id_delete: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_dns_domains_dns_domain_id_get**
> DNSDomain api_clusters_mgmt_v1_dns_domains_dns_domain_id_get(dns_domain_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_dns_domains_dns_domain_id_get(dns_domain_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_dns_domains_dns_domain_id_get: %s\n" % e)
```
...
# **api_clusters_mgmt_v1_dns_domains_dns_domain_id_patch**
> DNSDomain api_clusters_mgmt_v1_dns_domains_dns_domain_id_patch(dns_domain_id, dns_domain=dns_domain)
...
dns_domain = openapi_client.DNSDomain() # DNSDomain |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_dns_domains_dns_domain_id_patch: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **dns_domain_id** | **str**|  | 
 **dns_domain** | [**DNSDomain**](DNSDomain.md)|  | [optional] 
...
size = 56 # int | Maximum number of items that will be contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_dns_domains_get(page=page, search=search, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_dns_domains_get: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **page** | **int**| Index of the requested page, where one corresponds to the first page. | [optional] 
 **search** | **str**| Search criteria.  The syntax of this parameter is similar to the syntax of the _where_ clause of a SQL statement, but using the names of the attributes of the dns domain instead of the names of the columns of a table. For example, in order to retrieve all the dns domains with a ID starting with &#x60;02a5&#x60; should be:  &#x60;&#x60;&#x60;sql id like &#39;02a5%&#39; &#x60;&#x60;&#x60;  If the parameter isn&#39;t provided, or if the value is empty, then all the dns domains that the user has permission to see will be returned. | [optional] 
 **size** | **int**| Maximum number of items that will be contained in the returned page. | [optional] 
...
# **api_clusters_mgmt_v1_dns_domains_post**
> DNSDomain api_clusters_mgmt_v1_dns_domains_post(dns_domain=dns_domain)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_dns_domains_post: %s\n" % e)
```
...
> Environment api_clusters_mgmt_v1_environment_patch(environment=environment)
...
> Event api_clusters_mgmt_v1_events_post(event=event)
...
> Flavour api_clusters_mgmt_v1_flavours_flavour_id_patch(flavour_id, flavour=flavour)
...
> Flavour api_clusters_mgmt_v1_flavours_post(flavour=flavour)
...
> InlineResponse2004 api_clusters_mgmt_v1_gcp_inquiries_regions_post(page=page, size=size, cloud_provider_data=cloud_provider_data)
...
size = 56 # int | Number of items contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_oidc_configs_get(page=page, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_oidc_configs_get: %s\n" % e)
```
...
> api_clusters_mgmt_v1_oidc_configs_oidc_config_id_delete(oidc_config_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_oidc_configs_oidc_config_id_delete: %s\n" % e)
```
...
> OidcConfig api_clusters_mgmt_v1_oidc_configs_oidc_config_id_get(oidc_config_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_oidc_configs_oidc_config_id_get: %s\n" % e)
```
...
> OidcConfig api_clusters_mgmt_v1_oidc_configs_oidc_config_id_patch(oidc_config_id, oidc_config=oidc_config)
...
oidc_config = openapi_client.OidcConfig() # OidcConfig |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_oidc_configs_oidc_config_id_patch: %s\n" % e)
```
...
> OidcConfig api_clusters_mgmt_v1_oidc_configs_post(oidc_config=oidc_config)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_oidc_configs_post: %s\n" % e)
```
...
size = 56 # int | Maximum number of items that will be contained in the returned page. (optional)
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_pending_delete_clusters_get(order=order, page=page, search=search, size=size)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_pending_delete_clusters_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **order** | **str**| Order criteria.  The syntax of this parameter is similar to the syntax of the _order by_ clause of a SQL statement, but using the names of the attributes of the pending delete cluster instead of the names of the columns of a table. For example, in order to sort the pending delete clusters descending by creation timestamp (i.e. their deletion time) the value should be:  &#x60;&#x60;&#x60;sql creation_timestamp desc &#x60;&#x60;&#x60;  If the parameter isn&#39;t provided, or if the value is empty, then the order of the results is undefined. | [optional] 
 **page** | **int**| Index of the requested page, where one corresponds to the first page. | [optional] 
 **search** | **str**| Search criteria.  The syntax of this parameter is similar to the syntax of the _where_ clause of a SQL statement, but using the names of the attributes of the pending delete cluster instead of the names of the columns of a table. For example, in order to retrieve all the pending delete clusters with creation time later than 2023-03-01T00:00:00Z the following is required:  &#x60;&#x60;&#x60;sql creation_timestamp &gt; &#39;2023-03-01T00:00:00Z&#39; &#x60;&#x60;&#x60;  If the parameter isn&#39;t provided, or if the value is empty, then all the pending delete clusters that the user has permission to see will be returned. | [optional] 
 **size** | **int**| Maximum number of items that will be contained in the returned page. | [optional] 
...
> PendingDeleteCluster api_clusters_mgmt_v1_pending_delete_clusters_pending_delete_cluster_id_get(pending_delete_cluster_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.api_clusters_mgmt_v1_pending_delete_clusters_pending_delete_cluster_id_get(pending_delete_cluster_id)
        pprint(api_response)
    except ApiException as e:
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_pending_delete_clusters_pending_delete_cluster_id_get: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **pending_delete_cluster_id** | **str**|  | 

### Return type

[**PendingDeleteCluster**](PendingDeleteCluster.md)
...
> PendingDeleteCluster api_clusters_mgmt_v1_pending_delete_clusters_pending_delete_cluster_id_patch(pending_delete_cluster_id, pending_delete_cluster=pending_delete_cluster)
...
pending_delete_cluster = openapi_client.PendingDeleteCluster() # PendingDeleteCluster |  (optional)
    ...
    try:
        ...
        print("Exception when calling DefaultApi->api_clusters_mgmt_v1_pending_delete_clusters_pending_delete_cluster_id_patch: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **pending_delete_cluster_id** | **str**|  | 
 **pending_delete_cluster** | [**PendingDeleteCluster**](PendingDeleteCluster.md)|  | [optional] 
...
> ProvisionShard api_clusters_mgmt_v1_provision_shards_post(provision_shard=provision_shard)
...
> ProvisionShard api_clusters_mgmt_v1_provision_shards_provision_shard_id_patch(provision_shard_id, provision_shard=provision_shard)
...
size = 56 # int | Maximum number of items that will be contained in the returned page.  Default value is `100`. (optional)
...
> VersionGate api_clusters_mgmt_v1_version_gates_post(version_gate=version_gate)
