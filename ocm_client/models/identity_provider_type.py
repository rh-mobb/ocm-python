...
class IdentityProviderType(object):
    ...
    allowable_values = [LDAPIDENTITYPROVIDER, GITHUBIDENTITYPROVIDER, GITLABIDENTITYPROVIDER, GOOGLEIDENTITYPROVIDER, HTPASSWDIDENTITYPROVIDER, OPENIDIDENTITYPROVIDER]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """IdentityProviderType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IdentityProviderType):
            return False
