...
class InlineResponse20017(object):
    ...
    @property
    def size(self):
        """Gets the size of this InlineResponse20017.  # noqa: E501

        Number of items contained in the returned page.  # noqa: E501

        :return: The size of this InlineResponse20017.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this InlineResponse20017.

        Number of items contained in the returned page.  # noqa: E501

        :param size: The size of this InlineResponse20017.  # noqa: E501
        :type: int
        """
